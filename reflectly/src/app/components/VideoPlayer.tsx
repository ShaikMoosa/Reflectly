        ...
        {hasError && (
          <div className="absolute inset-0 flex items-center justify-center bg-black">
            <div className="text-center px-4">
              ...
              <h3 className="text-red-500 font-medium mb-1">Failed to load video</h3>
              <p className="text-sm text-gray-300">Please check that the video file is valid and try again.</p>
            </div>
          </div>
        )}
