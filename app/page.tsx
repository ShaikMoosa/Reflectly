                ...
                <div className="notes-section">
                  ...
                  {notes.length === 0 && transcripts.length === 0 ? (
                    ...
                    <div className="notes-layout">
                      ...
                      <div className="notes-column transcript-column">
                      ...
                      {/* Right side - User Notes */}
                      <div className="notes-column notes-column-right">
                        <div className="modern-card">
                          <div className="card-header">
                          ...
                          {notes.length > 0 ? (
                            ...
                            <div className="empty-notes">
                              <p>No notes yet. Add notes by clicking the Add Note button or directly from the transcript.</p>
                            </div>
                          )}
                        </div>
                      </div>
