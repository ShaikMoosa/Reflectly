...
const SideNavigation: React.FC<SideNavigationProps> = ({
  ...
  return (
    <aside className={`fixed inset-y-0 left-0 z-30 flex flex-col w-64 overflow-y-auto border-r ${isDarkMode ? 'dark bg-gray-900 text-gray-100 border-gray-700' : 'bg-white text-gray-800 border-gray-200'} transition-all duration-300`}>
        ...
        <nav>
          <ul className="space-y-1 px-2">
            ...
            <li>
              ...
              >
                <Kanban size={18} className="text-gray-500 dark:text-gray-400" />
                <span>Planner</span>
              </a>
            </li>
      ...
      <div className="mt-auto p-4 border-t border-gray-200 dark:border-gray-700">
        <Link 
          href="/account" 
          className="flex items-center gap-2 px-2 py-1.5 rounded-md text-sm hover:bg-gray-100 dark:hover:bg-gray-800 cursor-pointer mb-2"
        >
