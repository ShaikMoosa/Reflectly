...
# Reflectly Subscription System

This project contains a subscription management system for the Reflectly app, integrating with Supabase and LemonSqueezy for payment processing.

## Features

- User subscription management
- Subscription plan integration with LemonSqueezy
...
The project now includes a comprehensive test suite for the subscription system:

### Testing Infrastructure

- Jest configured for JavaScript tests
- Mocks for external dependencies (NextJS, Clerk, Supabase)
- Dedicated test scripts for subscription features
- Coverage reporting

### Test Categories

- API Tests: Testing subscription endpoints
- Repository Tests: Testing data access layer
- Demo Tests: Verifying test infrastructure
...
See the detailed testing documentation in `app/__tests__/TESTING_NOTES.md`.
